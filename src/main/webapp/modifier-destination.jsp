	...
	<form action="ModifierDestinationServlet2" method="POST">
		<div>
			<label for="region">Region : </label> <input name="region"
				id="region" type="text" value="${destination.region}" required/>
				<span id="error_region"class="error"></span>
		</div>
		<div>
			<label for="description">Description : </label><br>
			<textarea rows="6" cols="50" id="description" name="description" required>${destination.description}</textarea>
